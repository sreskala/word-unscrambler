    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            try
            {
                ...
                do
                {
                    Console.WriteLine(Constants.ScrambledWordOptions);
                    ...
                    //make decision to continue or not
                    var continueDecision = string.Empty;
                    do
                    {
                        Console.WriteLine(Constants.ContinueProgramOptions);
        ...
        private static void ExecuteScrambledWordsInFileScenario()
        {
            ...
            {
                Console.WriteLine(Constants.ScrambledWordsCannotBeLoaded + ex.Message);
            }
